...
public class WidgetSunMoon extends LinearLayout implements Handler.Callback {
    ...
    public WidgetSunMoon(Context context) {
        super(context, null, android.R.attr.borderlessButtonStyle);
        initView();
    }

    public WidgetSunMoon(Context context, AttributeSet attrs) {
        super(context, attrs, android.R.attr.borderlessButtonStyle);
        initView();
    }

    public WidgetSunMoon(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, android.R.attr.borderlessButtonStyle);
        initView();
    }

    private void initView(){
        inflate(getContext(), R.layout.widget_sun_moon,this);
