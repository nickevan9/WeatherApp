...
public class PlaceFragment extends Fragment implements ResultClickCallback,
    ...
    public static PlaceFragment newInstance(@NonNull String accessToken) {
    ...
    public static PlaceFragment newInstance(@NonNull String accessToken, @Nullable PlaceOptions placeOptions) {
        PlaceFragment fragment = new PlaceFragment();
        Bundle bundle = new Bundle();
        bundle.putString(PlaceConstants.ACCESS_TOKEN, accessToken);
    ...
    private void subscribe() {
        viewModel.geocodingLiveData.observe(getViewLifecycleOwner(), geocodingResponse -> {
        ...
        DataRepository.getInstance(viewModel.getDatabase()).getSearchHistory().observe(getViewLifecycleOwner(),
                searchHistoryEntities -> updateSearchHistoryView(searchHistoryEntities));
    }
